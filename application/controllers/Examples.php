...
class Examples extends CI_Controller {
	...
	public function Flight()
	{
		...
		// $crud->columns('GuiID','GuiFileName', 'Comment');
	...
	public function GuiLink()
	{
		...
		$crud = new grocery_CRUD();
		$crud->set_theme('datatables');
		// $crud->set_table('GUILink');
		$crud->set_table('IPAddress');
		$crud->columns('IPAddress','AirlinesINX','Deletef');
		...
		/*void set_relation_n_n(string $field_name, string $relation_table, string $selection_table, string $primary_key_alias_to_this_table, string $primary_key_alias_to_selection_table , string $title_field_selection_table [ , string $priority_field_relation [, string $where_clause]]
 		...
 		// $crud->set_relation_n_n('Name', 'Airlines', 'Airlines','AirlinesINX', 'AirlinesINX', 'Name');

    // $crud->set_relation('IPAddress.IPAddressINX','GUILink','GUILink.IPAddress');
    
		// $crud->display_as('IPAddress','IPAddressINX');
		// $crud->display_as('IPAddress','IPAddressINX');
		// $crud->set_relation('IPAddress','IPAddress','AirlinesINX');
		// $crud->columns('GuiID','GuiFileName', 'Comment');
